...
export const toejAccessoriesCategories: Category[] = [
  ...
  },
  {
    ...
    regex:
      "TØJ & SKO > Børnetøj og sko|BØRNETØJ & -SKO|Brands  > Bow`s By Stær",
  },
];
...
export const sovetidCategories: Category[] = [
  ...
  },
  {
    ...
    name: "Sengerand",
    regex:
      "For babies | for babies|Sengerand|Sengerandsslange|Sengerende|Sengelomme",
  },
  {
    slug: "sengetoej",
    name: "Sengetøj",
  ...
  },
  {
    ...
    name: "Senge",
    regex:
      "Stokke Sleepi|Kombi-og junior senge|Babyseng|Babysenge|Leander Babysenge|Barneseng|Børneseng|Juniorseng|Boerneseng|Tremmeseng|Voksenseng|Rejsesenge|Sengeudstyr",
  },
  {
    slug: "dyner-og-puder",
    name: "Dyner og puder",
...
export const legetoejIndendoersCategories: Category[] = [
  ...
  },
  {
    ...
    regex: "Gåbil|Gåvogn|Gå-vogn|Modu|Vippe|Gå og skubbe vogne|Gåstol",
  },
  {
...
export const legetoejAndetCategories: Category[] = [
  {
    ...
    name: "Andet legetøj",
    regex:
      "Legetøj|Øvrigt legetøj|Small foot|Regne & måle|Hoppedyr|Gynge|Kreativ",
  },
];
...
export const barselOgAmningCategories: Category[] = [
  ...
  },
  {
    ...
    name: "Gaver",
    regex:
      "Giftbag|Gift Set|Gift Bundle|Babybox|Cuddle up box|Dress me up box|Snuggle up box|Swaddle up box|Sweet dream box|Barselsgaver|Rav",
  },
];
